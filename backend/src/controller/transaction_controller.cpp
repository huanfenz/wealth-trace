...
TransactionInput transaction_input(const nlohmann::json& body){
  ...
  in.category_id=dto::optional_int64(body,"category_id");in.preserve_legacy_category=dto::optional_bool(body,"preserve_legacy_category",false);in.transaction_time=body_time(body).value_or("");in.remark=body_remark(body);
